  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      ...
      <div className={`bg-white border p-6 shadow-sm transition-all ${urgentCount > 0 ? 'border-red-200 bg-red-50/30' : 'border-gray-100'}`}>
        ...
        <p className="text-[9px] text-gray-300 font-bold mt-4 italic">* 법정 의무 교육 미이수 시 과태료 리스크</p>
      </div>
      ...
      <div className="bg-[#232933] p-6 shadow-xl flex flex-col">
        ...
        <p className="text-[10px] text-gray-400 font-bold mt-auto pt-4 border-t border-white/5">
          의료진 및 행정직 필수 이수 항목
        </p>
      </div>
    </div>
