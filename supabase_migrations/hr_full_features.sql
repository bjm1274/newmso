...
CREATE TABLE IF NOT EXISTS tax_insurance_rates (
  ...
  company_name TEXT DEFAULT '전체',
  national_pension_rate DECIMAL(7,6) DEFAULT 0.0475,
  health_insurance_rate DECIMAL(7,6) DEFAULT 0.03595,
  long_term_care_rate DECIMAL(7,6) DEFAULT 0.004724,
  employment_insurance_rate DECIMAL(7,6) DEFAULT 0.009,
