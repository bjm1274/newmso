    ...
    <div className="flex flex-col h-full min-h-0 bg-[#F8FAFC] overflow-hidden relative">
      ...
      <div className="flex-1 flex flex-col md:flex-row overflow-hidden">
        <main className="flex-1 p-4 md:p-10 bg-[#F8FAFC] overflow-y-auto custom-scrollbar">
          {activeView === '현황' && (
            loading ? (
              <div className="h-full flex items-center justify-center font-bold text-[#8B95A1]">데이터 동기화 중...</div>
            ) : (
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-between items-stretch sm:items-center">
                  <div className="flex-1 flex flex-wrap items-center gap-2">
                    <select
                      ...
                      className="px-3 py-3 rounded-[12px] border border-[#E5E8EB] bg-white text-sm font-bold min-w-[140px]"
                      title="회사 선택"
                    >
                    ...
                    <select
                      ...
                      className="px-3 py-3 rounded-[12px] border border-[#E5E8EB] bg-white text-sm font-bold min-w-[120px]"
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[110] flex items-center justify-center p-4" onClick={() => setShowLogs(false)}>
          <div className="bg-white rounded-lg shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col" onClick={e => e.stopPropagation()}>
            ...
            <div className="flex-1 overflow-y-auto p-4">
              {logs.length === 0 ? (
                <p className="text-center text-[#8B95A1] font-bold py-12">이력이 없습니다.</p>
              ) : (
