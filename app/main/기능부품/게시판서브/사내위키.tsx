      ...
      <aside className="flex w-full shrink-0 flex-col border-b border-[var(--border)] bg-[var(--tab-bg)]/35 md:w-[320px] md:border-b-0 md:border-r">
        <div className="space-y-3 border-b border-[var(--border)] p-4">
          <div className="flex items-start justify-between gap-3">
            ...
            <button type="button" onClick={() => void createFolder()} className="rounded-[var(--radius-lg)] bg-[var(--foreground)] px-3.5 py-2 text-[11px] font-bold text-white">+ Folder</button>
          </div>
          <div className="flex gap-2">
            ...
            <button type="button" onClick={() => void createDocument()} className="rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--card)] px-3.5 text-[11px] font-bold text-[var(--accent)]">+ Doc</button>
          </div>
        </div>
        ...
        {schemaReady && selectedDocument ? (
          <>
            <header className="flex flex-wrap items-start justify-between gap-3 border-b border-[var(--border)] px-5 py-4">
              ...
              <button type="button" onClick={() => void saveDocument()} disabled={saving || !dirty} className="rounded-[var(--radius-lg)] bg-[var(--accent)] px-3.5 py-2 text-[11px] font-bold text-white disabled:opacity-50">{saving ? 'Saving...' : dirty ? 'Save' : 'Saved'}</button>
            </header>
