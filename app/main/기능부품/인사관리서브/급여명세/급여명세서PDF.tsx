...
export default function PayrollSlipPDF({ staff: _staff, record: _record, yearMonth: _yearMonth }: Record<string, unknown>) {
  ...
  return (
    <div className="rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--card)] p-4 shadow-sm">
      <div
        ref={printRef}
        className="overflow-hidden rounded-[var(--radius-xl)] bg-white"
      ...
      >
        ...
        <div className="border-t px-4 py-5" style={{ borderColor: design.borderColor }}>
      ...
      <button
        type="button"
        onClick={handlePrint}
        className="mt-4 w-full rounded-[var(--radius-md)] px-4 py-2.5 text-sm font-semibold text-white"
