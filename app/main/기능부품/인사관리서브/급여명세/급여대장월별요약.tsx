  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-4 shadow-sm">
      <div className="pb-3 border-b border-gray-100 mb-3">
        <h3 className="text-sm font-semibold text-gray-800">월별 급여 요약</h3>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-xs">
            <span className="font-medium text-gray-500">정산 인원</span>
            <span className="font-semibold text-gray-800">{records.length}명</span>
          </div>
          <div className="flex justify-between text-xs">
            <span className="font-medium text-gray-500">과세 총액</span>
            <span className="font-medium text-gray-700">{totalTaxable.toLocaleString()}원</span>
          </div>
          <div className="flex justify-between text-xs">
            <span className="font-medium text-gray-500">공제 합계</span>
            <span className="font-medium text-red-600">-{totalDeduction.toLocaleString()}원</span>
          </div>
          <div className="flex justify-between text-sm pt-2 border-t border-gray-200">
            <span className="font-medium text-gray-600">실지급 총액</span>
            <span className="font-semibold text-blue-600">₩{totalNet.toLocaleString()}</span>
          </div>
        </div>
      )}
    </div>
