    ...
    return (
        <div className="space-y-4 animate-in fade-in duration-500 max-w-7xl mx-auto pb-12" data-testid="admin-analysis-financial">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div className="p-4 bg-[var(--toss-blue-light)] rounded-3xl border border-[var(--toss-blue)]/20">
                    <div className="flex items-center gap-3 mb-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="bg-slate-900 rounded-3xl p-4 md:p-5 shadow-xl text-white relative overflow-hidden flex flex-col justify-center border border-slate-700">
