...
귀하의 ${schedule.targetYear}년도 발생 연차유급휴가 중 현재까지 사용하지 아니한 휴가는 총 ${remain}일입니다.
...
이에 회사는 근로기준법 제61조 제2항에 따라 귀하의 미사용 연차유급휴가 총 ${remain}일에 대하여 아래와 같이 사용 시기를 지정하여 통보합니다.
