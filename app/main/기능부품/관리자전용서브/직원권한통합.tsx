        ...
        <div className="flex-1 overflow-y-auto bg-[var(--toss-gray-1)]/40">
          <div className="space-y-2 p-2">
            {groupedStaffSections.map((companySection) => (
              <section key={companySection.company} className="overflow-hidden rounded-[14px] border border-[var(--toss-border)] bg-white/90 shadow-sm">
                <div className="border-b border-[var(--toss-border)] bg-[var(--toss-gray-1)] px-3 py-2">
                      ...
                      <div className="space-y-1">
                        {teamSection.members.map((staff) => (
                          <button
                            ...
                            className={`w-full rounded-[10px] px-2 py-1.5 text-left transition-all ${
                      ...
                      <div className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
                        ...
                        <div className="flex gap-2">
                          <button
                            ...
                            className="rounded-[10px] bg-[var(--toss-blue-light)] px-2.5 py-1.5 text-[10px] font-bold text-[var(--toss-blue)]"
                          >
                            전체 허용
                          </button>
                          <button
                            ...
                            className="rounded-[10px] bg-[var(--toss-gray-1)] px-2.5 py-1.5 text-[10px] font-bold text-[var(--toss-gray-4)]"
                          >
                            전체 해제
                          </button>
                        </div>
