/* ===========================================================
   Unified Parametric Emoticon Engine (TypeScript / React)
   Includes 60 Emoticon Definitions & Self-Contained Styles
   =========================================================== */

export interface EmoticonDef {
  id: string;
  label: string;
  group: 'office' | 'hospital' | 'developer' | 'custom';
  anim: string;
  uniform: string;
  front: string[];
  face: {
...
export const EMO_OFFICE: EmoticonDef[] = [
  { id: "o-coffee", label: "커피수혈", group: "office", anim: "a-pulse", uniform: "suit", front: ["coffee"], face: { skin: "#ffe0c2", hair: "short", hairColor: "brown", tieColor: "#6f9bd1", eyes: "shine", mouth: "smile", blush: true, fx: ["sparkles"] } },
  { id: "o-overtime", label: "야근각...", group: "office", anim: "a-droop", uniform: "shirt", front: ["doc"], face: { skin: "#f7c9a3", hair: "sidepart", hairColor: "dark", glasses: true, eyes: "x", mouth: "flat", brow: "worried", fx: ["moon", "lines"] } },
  { id: "o-leaveontime", label: "칼퇴!!", group: "office", anim: "a-jump", uniform: "suit", front: [], face: { skin: "#ffd2b0", hair: "ponytail", hairColor: "brown", tieColor: "#d96b7c", eyes: "happy", mouth: "bigsmile", blush: true, fx: ["sparkles", "note"] } },
  { id: "o-monday", label: "월요병", group: "office", anim: "a-droop", uniform: "suit", front: [], face: { skin: "#f7c9a3", hair: "bob", hairColor: "dark", tieColor: "#6f9bd1", eyes: "cry", mouth: "frown", brow: "worried", fx: ["tears", "lines"] } },
  { id: "o-meltdown", label: "멘붕", group: "office", anim: "a-shake", uniform: "suit", front: [], face: { skin: "#ffe0c2", hair: "quiff", hairColor: "brown", tieColor: "#c9a14a", eyes: "dizzy", mouth: "wavy", fx: ["sweat2"] } },
  { id: "o-meeting", label: "회의중...", group: "office", anim: "a-float", uniform: "shirt", front: ["clipboard"], face: { skin: "#e8b389", hair: "sidepart", hairColor: "brown", glasses: true, eyes: "sleepy", mouth: "flat", brow: "flat", fx: ["zzz"] } },
  { id: "o-deadline", label: "마감임박", group: "office", anim: "a-vibrate", uniform: "suit", front: ["clock"], face: { skin: "#ffd2b0", hair: "bun", hairColor: "auburn", tieColor: "#d96b7c", eyes: "wide", mouth: "gritted", brow: "worried", fx: ["sweat2", "alarm"] } },
  { id: "o-boss", label: "상사눈치", group: "office", anim: "a-vibrate", uniform: "suit", front: [], face: { skin: "#ffe0c2", hair: "short", hairColor: "dark", tieColor: "#5fae8c", eyes: "side", mouth: "flat", brow: "worried", fx: ["sweat"] } },
  { id: "o-praise", label: "칭찬받음", group: "office", anim: "a-bounce", uniform: "suit", front: [], face: { skin: "#f7c9a3", hair: "bob", hairColor: "brown", tieColor: "#d96b7c", eyes: "star", mouth: "bigsmile", blush: true, fx: ["sparkles"] } },
  { id: "o-swamped", label: "폭풍업무", group: "office", anim: "a-shake", uniform: "shirt", front: [], face: { skin: "#ffd2b0", hair: "quiff", hairColor: "dark", eyes: "wide", mouth: "gasp", brow: "worried", fx: ["flypaper", "sweat2"] } },
  { id: "o-payday", label: "월급날", group: "office", anim: "a-jump", uniform: "suit", front: [], face: { skin: "#ffe0c2", hair: "short", hairColor: "lbrown", tieColor: "#c9a14a", eyes: "money", mouth: "bigsmile", blush: true, fx: ["sparkles"] } },
  { id: "o-angry", label: "빡침", group: "office", anim: "a-shake", uniform: "suit", front: [], face: { skin: "#ffc6ad", hair: "short", hairColor: "dark", tieColor: "#6f9bd1", eyes: "angry", mouth: "gritted", brow: "angry", fx: ["anger", "steamhead"] } },
  { id: "o-sleepy", label: "졸림", group: "office", anim: "a-float", uniform: "shirt", front: [], face: { skin: "#f7c9a3", hair: "sidepart", hairColor: "brown", eyes: "sleepy", mouth: "smallo", fx: ["zzz"] } },
  { id: "o-blank", label: "멍...", group: "office", anim: "a-float", uniform: "suit", front: [], face: { skin: "#e8b389", hair: "bob", hairColor: "dark", tieColor: "#5fae8c", eyes: "blank", mouth: "smallo", brow: "flat", fx: ["lines"] } },
  { id: "o-wanttogo", label: "퇴근하고파", group: "office", anim: "a-tilt", uniform: "suit", front: ["clock"], face: { skin: "#ffd2b0", hair: "ponytail", hairColor: "auburn", tieColor: "#d96b7c", eyes: "cry", mouth: "frown", brow: "worried", fx: ["tearjoy"] } },
  { id: "o-lunch", label: "점심뭐먹지", group: "office", anim: "a-tilt", uniform: "shirt", front: [], face: { skin: "#ffe0c2", hair: "short", hairColor: "brown", glasses: true, eyes: "dot", mouth: "smirk", fx: ["question"] } },
  { id: "o-fighting", label: "화이팅!", group: "office", anim: "a-bounce", uniform: "suit", front: ["fist"], face: { skin: "#f7c9a3", hair: "quiff", hairColor: "dark", tieColor: "#5fae8c", eyes: "happy", mouth: "grin", brow: "raised", blush: true, fx: ["exclaim"] } },
  { id: "o-existential", label: "현타옴", group: "office", anim: "a-droop", uniform: "suit", front: [], face: { skin: "#e8b389", hair: "baldsides", hairColor: "gray", tieColor: "#6f9bd1", eyes: "blank", mouth: "flat", brow: "worried", fx: ["lines", "moon"] } },
  { id: "o-approve", label: "결재부탁", group: "office", anim: "a-nod", uniform: "suit", front: ["doc"], face: { skin: "#ffd2b0", hair: "sidepart", hairColor: "dark", tieColor: "#c9a14a", eyes: "smile", mouth: "small", blush: true, fx: ["sweat"] } },
  { id: "o-wfh", label: "칼답 대기", group: "office", anim: "a-vibrate", uniform: "shirt", front: ["phone"], face: { skin: "#ffe0c2", hair: "bob", hairColor: "brown", eyes: "wide", mouth: "flat", brow: "worried", fx: ["exclaim"] } }
];

export const EMO_HOSPITAL: EmoticonDef[] = [
  { id: "h-night", label: "야간당직", group: "hospital", anim: "a-droop", uniform: "coat", front: ["capnurse"], face: { skin: "#f7c9a3", hair: "bob", hairColor: "dark", eyes: "x", mouth: "flat", brow: "worried", fx: ["moon", "lines"] } },
  { id: "h-rounds", label: "회진중", group: "hospital", anim: "a-nod", uniform: "coat", front: ["capdoc", "clipboard"], face: { skin: "#ffe0c2", hair: "sidepart", hairColor: "brown", glasses: true, eyes: "smile", mouth: "small", blush: true, fx: [] } },
  { id: "h-emergency", label: "응급!!", group: "hospital", anim: "a-shake", uniform: "scrubs", front: ["capdoc"], face: { skin: "#ffd2b0", hair: "short", hairColor: "dark", eyes: "wide", mouth: "gasp", brow: "worried", fx: ["alarm", "sweat2"] } },
  { id: "h-chart", label: "차트작성", group: "hospital", anim: "a-float", uniform: "scrubs", front: ["capnurse", "clipboard"], face: { skin: "#f7c9a3", hair: "ponytail", hairColor: "brown", eyes: "sleepy", mouth: "flat", brow: "flat", fx: ["zzz"] } },
  { id: "h-inject", label: "주사들어갑니다", group: "hospital", anim: "a-tilt", uniform: "scrubs", front: ["capnurse", "syringe"], face: { skin: "#ffe0c2", hair: "bun", hairColor: "auburn", eyes: "wink", mouth: "smile", blush: true, fx: ["sparkles"] } },
  { id: "h-care", label: "환자케어", group: "hospital", anim: "a-bounce", uniform: "coat", front: ["capnurse"], face: { skin: "#ffd2b0", hair: "bob", hairColor: "brown", eyes: "heart", mouth: "bigsmile", blush: true, fx: ["heartup"] } },
  { id: "h-sanitize", label: "손소독", group: "hospital", anim: "a-wobble", uniform: "scrubs", front: ["capnurse"], face: { skin: "#ffe0c2", hair: "ponytail", hairColor: "dark", eyes: "happy", mouth: "smile", blush: true, fx: ["bubble"] } },
  { id: "h-mask", label: "마스크답답", group: "hospital", anim: "a-droop", uniform: "scrubs", front: ["capdoc", "mask"], face: { skin: "#f7c9a3", hair: "short", hairColor: "dark", eyes: "sleepy", mouth: "none", brow: "worried", fx: ["sweat2"] } },
  { id: "h-codeblue", label: "코드블루", group: "hospital", anim: "a-vibrate", uniform: "scrubs", front: ["capdoc"], face: { skin: "#ffd2b0", hair: "short", hairColor: "brown", eyes: "wide", mouth: "gasp", brow: "worried", fx: ["alarm", "sweat2", "exclaim"] } },
  { id: "h-shift", label: "교대요청", group: "hospital", anim: "a-swing", uniform: "scrubs", front: ["capnurse", "fist"], face: { skin: "#ffe0c2", hair: "ponytail", hairColor: "brown", eyes: "happy", mouth: "grin", blush: true, fx: ["note"] } },
  { id: "h-hungry", label: "밥은언제", group: "hospital", anim: "a-droop", uniform: "scrubs", front: ["capnurse"], face: { skin: "#f7c9a3", hair: "bob", hairColor: "dark", eyes: "cry", mouth: "frown", brow: "worried", fx: ["tearjoy", "lines"] } },
  { id: "h-counsel", label: "보호자상담", group: "hospital", anim: "a-nod", uniform: "coat", front: ["capdoc"], face: { skin: "#ffd2b0", hair: "sidepart", hairColor: "brown", glasses: true, eyes: "smile", mouth: "smile", blush: true, fx: [] } },
  { id: "h-surgery", label: "수술중", group: "hospital", anim: "a-vibrate", uniform: "scrubs", front: ["capdoc", "mask"], face: { skin: "#ffe0c2", hair: "short", hairColor: "dark", eyes: "wide", mouth: "none", brow: "flat", fx: ["sweat", "exclaim"] } },
  { id: "h-prescribe", label: "처방나갑니다", group: "hospital", anim: "a-bounce", uniform: "coat", front: ["capdoc", "pills"], face: { skin: "#f7c9a3", hair: "sidepart", hairColor: "dark", eyes: "wink", mouth: "smile", blush: true, fx: ["sparkles"] } },
  { id: "h-off", label: "퇴근합니다", group: "hospital", anim: "a-jump", uniform: "scrubs", front: ["capnurse"], face: { skin: "#ffd2b0", hair: "bob", hairColor: "brown", eyes: "happy", mouth: "bigsmile", blush: true, fx: ["sparkles", "note"] } },
  { id: "h-thanks", label: "감사인사", group: "hospital", anim: "a-bounce", uniform: "coat", front: ["capnurse"], face: { skin: "#ffe0c2", hair: "bun", hairColor: "brown", eyes: "cry", mouth: "bigsmile", blush: true, fx: ["tearjoy", "heartup"] } },
  { id: "h-burnout", label: "번아웃", group: "hospital", anim: "a-shake", uniform: "scrubs", front: ["capnurse"], face: { skin: "#f7c9a3", hair: "ponytail", hairColor: "dark", eyes: "dizzy", mouth: "wavy", fx: ["sweat2", "lines"] } },
  { id: "h-coffee", label: "카페인충전", group: "hospital", anim: "a-pulse", uniform: "coat", front: ["capdoc", "coffee"], face: { skin: "#ffe0c2", hair: "short", hairColor: "brown", eyes: "shine", mouth: "smile", blush: true, fx: ["sparkles"] } },
  { id: "h-cheer", label: "화이팅!", group: "hospital", anim: "a-bounce", uniform: "scrubs", front: ["capnurse", "fist"], face: { skin: "#ffd2b0", hair: "ponytail", hairColor: "auburn", eyes: "happy", mouth: "grin", brow: "raised", blush: true, fx: ["exclaim"] } },
  { id: "h-drowsy", label: "졸음쏟아짐", group: "hospital", anim: "a-float", uniform: "scrubs", front: ["capnurse"], face: { skin: "#f7c9a3", hair: "bob", hairColor: "dark", eyes: "sleepy", mouth: "smallo", fx: ["zzz", "moon"] } }
];

export const EMO_DEVELOPER: EmoticonDef[] = [
  { id: "d-coding", label: "폭풍코딩", group: "developer", anim: "a-vibrate", uniform: "hoodie", front: ["laptop"], face: { skin: "#ffe0c2", hair: "short", hairColor: "dark", eyes: "shine", mouth: "grin", blush: true, fx: ["matrix"] } },
  { id: "d-bug", label: "버그발생!", group: "developer", anim: "a-shake", uniform: "checkshirt", front: ["bug"], face: { skin: "#ffd2b0", hair: "sidepart", hairColor: "brown", glasses: true, eyes: "wide", mouth: "gasp", brow: "worried", fx: ["error"] } },
  { id: "d-caffeine", label: "카페인 수혈", group: "developer", anim: "a-pulse", uniform: "hoodie", front: ["energy"], face: { skin: "#ffe0c2", hair: "quiff", hairColor: "lbrown", eyes: "shine", mouth: "smile", blush: true, fx: ["sparkles"] } },
  { id: "d-compile", label: "컴파일중", group: "developer", anim: "a-float", uniform: "hoodie", front: ["laptop"], face: { skin: "#f7c9a3", hair: "bob", hairColor: "dark", eyes: "sleepy", mouth: "flat", brow: "flat", fx: ["lines"] } },
  { id: "d-release", label: "배포성공!!", group: "developer", anim: "a-jump", uniform: "hoodie", front: ["laptop"], face: { skin: "#ffe0c2", hair: "short", hairColor: "brown", tieColor: "#d96b7c", eyes: "star", mouth: "bigsmile", blush: true, fx: ["sparkles"] } },
  { id: "d-lgtm", label: "LGTM!", group: "developer", anim: "a-bounce", uniform: "checkshirt", front: ["fist"], face: { skin: "#ffd2b0", hair: "quiff", hairColor: "dark", eyes: "happy", mouth: "grin", blush: true, fx: ["heartup"] } },
  { id: "d-serverdown", label: "서버 터짐", group: "developer", anim: "a-shake", uniform: "hoodie", front: [], face: { skin: "#ffc6ad", hair: "buzz", hairColor: "dark", eyes: "x", mouth: "wavy", brow: "angry", fx: ["fire"] } },
  { id: "d-headphones", label: "개발몰입", group: "developer", anim: "a-nod", uniform: "hoodie", front: ["headphones"], face: { skin: "#ffe0c2", hair: "short", hairColor: "brown", eyes: "sleepy", mouth: "smile", fx: ["zzz"] } },
  { id: "d-stackoverflow", label: "검색신공", group: "developer", anim: "a-tilt", uniform: "checkshirt", front: ["laptop"], face: { skin: "#e8b389", hair: "sidepart", hairColor: "brown", glasses: true, eyes: "dot", mouth: "smirk", fx: ["question"] } },
  { id: "d-gitpush", label: "깃 푸시!", group: "developer", anim: "a-bounce", uniform: "hoodie", front: ["laptop"], face: { skin: "#ffd2b0", hair: "ponytail", hairColor: "auburn", eyes: "wink", mouth: "smile", blush: true, fx: ["sparkles"] } },
  { id: "d-turtle", label: "거북목 증후군", group: "developer", anim: "a-droop", uniform: "hoodie", front: [], face: { skin: "#f7c9a3", hair: "bob", hairColor: "dark", eyes: "blank", mouth: "flat", brow: "worried", fx: ["lines"] } },
  { id: "d-specs", label: "기획 변경...", group: "developer", anim: "a-droop", uniform: "checkshirt", front: [], face: { skin: "#ffe0c2", hair: "short", hairColor: "brown", eyes: "x", mouth: "frown", brow: "worried", fx: ["sweat2", "lines"] } },
  { id: "d-refactor", label: "리팩토링", group: "developer", anim: "a-pulse", uniform: "hoodie", front: ["laptop"], face: { skin: "#ffe0c2", hair: "sidepart", hairColor: "lbrown", eyes: "shine", mouth: "smile", blush: true, fx: ["bubble"] } },
  { id: "d-keyboard", label: "키보드 샷건", group: "developer", anim: "a-vibrate", uniform: "hoodie", front: [], face: { skin: "#ffc6ad", hair: "short", hairColor: "dark", eyes: "angry", mouth: "gritted", brow: "angry", fx: ["anger"] } },
  { id: "d-zoom", label: "화상회의", group: "developer", anim: "a-nod", uniform: "checkshirt", front: ["laptop"], face: { skin: "#ffd2b0", hair: "bob", hairColor: "brown", eyes: "dot", mouth: "smile", blush: true, fx: ["sweat"] } },
  { id: "d-salary", label: "연봉협상", group: "developer", anim: "a-jump", uniform: "suit", front: [], face: { skin: "#ffe0c2", hair: "short", hairColor: "lbrown", tieColor: "#6f9bd1", eyes: "money", mouth: "grin", blush: true, fx: ["sparkles"] } },
  { id: "d-allnight", label: "철야코딩", group: "developer", anim: "a-droop", uniform: "hoodie", front: ["mug"], face: { skin: "#f7c9a3", hair: "bun", hairColor: "auburn", eyes: "cry", mouth: "flat", brow: "worried", fx: ["moon", "lines"] } },
  { id: "d-dbrecovery", label: "디비복구", group: "developer", anim: "a-shake", uniform: "hoodie", front: [], face: { skin: "#ffd2b0", hair: "sidepart", hairColor: "dark", eyes: "wide", mouth: "gritted", brow: "worried", fx: ["alarm"] } },
  { id: "d-cleanup", label: "코드 정리", group: "developer", anim: "a-wobble", uniform: "checkshirt", front: [], face: { skin: "#ffe0c2", hair: "short", hairColor: "brown", eyes: "happy", mouth: "smile", blush: true, fx: ["sparkles"] } },
  { id: "d-approve", label: "승인대기", group: "developer", anim: "a-nod", uniform: "hoodie", front: ["laptop"], face: { skin: "#f7c9a3", hair: "bob", hairColor: "dark", eyes: "wink", mouth: "small", blush: true, fx: ["sweat"] } }
];

export const ALL_EMOTICONS: EmoticonDef[] = [...EMO_OFFICE, ...EMO_HOSPITAL, ...EMO_DEVELOPER];

export function getEmoticonDef(id: string): EmoticonDef | undefined {
  return ALL_EMOTICONS.find(e => e.id === id);
}

// ---------------- SVG PARAMETRIC GENERATOR WITH EMBEDDED DYNAMIC STYLES ----------------
...
const CX = 50, CYH = 39, R = 24;
const LX = 41, RX = 59, EY = 40;
const MY = 52;

// Embedding css keyframe animations inside a style tag for fully self-contained playback!
const EMBEDDED_ANIMATIONS_CSS = `
  @keyframes emo-bounce {
    0%,100% { transform: translateY(0) scale(1,1); }
    30%     { transform: translateY(-14%) scale(0.94,1.08); }
    55%     { transform: translateY(2%) scale(1.08,0.92); }
    70%     { transform: translateY(-5%) scale(0.98,1.02); }
  }
  @keyframes emo-jump {
    0%,100% { transform: translateY(0) scale(1,1); }
    20%     { transform: translateY(3%) scale(1.12,0.86); }
    45%     { transform: translateY(-26%) scale(0.9,1.12); }
    70%     { transform: translateY(0) scale(1.06,0.94); }
  }
  @keyframes emo-shake {
    0%,100% { transform: translateX(0) rotate(0); }
    20% { transform: translateX(-7%) rotate(-5deg); }
    40% { transform: translateX(7%) rotate(5deg); }
    60% { transform: translateX(-5%) rotate(-3deg); }
    80% { transform: translateX(5%) rotate(3deg); }
  }
  @keyframes emo-wobble {
  ...
  @keyframes emo-nod {
    ...
    30% { transform: translateY(6%) rotate(4deg); }
    60% { transform: translateY(0) rotate(-2deg); }
  }
  @keyframes emo-vibrate {
  ...
  @keyframes emo-droop {
    ...
    60% { transform: translateY(8%) scale(1.04,0.92); }
    100% { transform: translateY(6%) scale(1.02,0.95); }
  }
  @keyframes emo-swing {
    0%,100% { transform: rotate(-6deg); }
    50% { transform: rotate(6deg); }
  }
  @keyframes emo-steam { 0%{opacity:.2;transform:translateY(2px);} 50%{opacity:.9;} 100%{opacity:0;transform:translateY(-5px);} }
  @keyframes emo-sweatdrop { 0%{opacity:0;transform:translateY(-3px) scale(.7);} 30%{opacity:1;transform:translateY(0) scale(1);} 100%{opacity:0;transform:translateY(8px) scale(.9);} }
  @keyframes emo-tearfall { 0%{opacity:0;transform:translateY(0) scale(.6);} 20%{opacity:1;} 100%{opacity:0;transform:translateY(18px) scale(1.1);} }
  @keyframes emo-zzz { 0%{opacity:0;transform:translate(0,2px);} 40%{opacity:1;} 100%{opacity:0;transform:translate(5px,-8px);} }
  @keyframes emo-spark { 0%,100%{opacity:.2;transform:scale(.6);} 50%{opacity:1;transform:scale(1.1);} }
  @keyframes emo-floatup { 0%{opacity:0;transform:translateY(4px) scale(.7);} 30%{opacity:1;} 100%{opacity:0;transform:translateY(-14px) scale(1.05);} }
  @keyframes emo-pop { 0%{opacity:0;transform:scale(.3);} 50%{opacity:1;transform:scale(1.25);} 70%{transform:scale(.95);} 100%{opacity:1;transform:scale(1);} }
  @keyframes emo-tick { 0%,100%{transform:rotate(0);} 50%{transform:rotate(60deg);} }
  @keyframes emo-fly { 0%{opacity:.3;transform:translate(0,0) rotate(0);} 50%{opacity:1;} 100%{opacity:.2;transform:translate(6px,-10px) rotate(40deg);} }
  
  .emo-steam { animation: emo-steam 1.4s ease-in-out infinite; }
  .emo-sweat { animation: emo-sweatdrop 1.5s ease-in infinite; }
  .emo-tearfall { animation: emo-tearfall 1.3s ease-in infinite; }
  .emo-zzz { animation: emo-zzz 2s ease-in-out infinite; }
  .emo-spark { animation: emo-spark 1.1s ease-in-out infinite; transform-box: fill-box; transform-origin:center; }
  .emo-floatup { animation: emo-floatup 1.8s ease-out infinite; }
...
function star(cx: number, cy: number, s: number, fill: string) {
  const p = [];
  for (let i = 0; i < 5; i++) {
...
function sparkle(cx: number, cy: number, s: number, fill: string) {
...
function drop(cx: number, cy: number, s: number, fill: string) {
  return `<path transform="translate(${cx} ${cy}) scale(${s})" d="M0 -5 C2.8 -1 3 1 3 2.4 A3 3 0 1 1 -3 2.4 C-3 1 -2.8 -1 0 -5 Z" fill="${fill}"/>`;
}

function eyes(type: string) {
  const dot = (x: number) => `<circle cx="${x}" cy="${EY}" r="3" fill="${ST}"/>`;
  const shine = (x: number) => `<circle cx="${x + 1}" cy="${EY - 1.2}" r="0.9" fill="#fff"/>`;
  switch (type) {
    ...
    case "dizzy":
      const sp = (cx: number) => `<path d="M${cx} ${EY} m-4 0 a4 4 0 1 1 8 0 a2.7 2.7 0 1 1 -5.4 0 a1.5 1.5 0 1 1 3 0" stroke="${ST}" stroke-width="1.6" fill="none"/>`;
      return sp(LX) + sp(RX);
...
function arc(cx: number, dir: string) {
  if (dir === "up")
...
function brow(type: string | undefined) {
...
function hair(style: string, col: string) {
...
function torso(def: EmoticonDef) {
  ...
  const sh = `M8 100 Q9 80 28 74 L40 71 Q50 81 60 71 L72 74 Q91 80 92 100 Z`;
  let s = `<path d="${sh}" fill="${col(u)}" stroke="${ST}" stroke-width="2" stroke-linejoin="round"/>`;
  if (u === "suit") {
    s += `<path d="M40 71 Q50 81 60 71 L57 92 L43 92 Z" fill="#fff" stroke="${ST}" stroke-width="1.4" stroke-linejoin="round"/>`;
    s += `<path d="M41 71 L50 80 L45 86 Z" fill="#fff" stroke="${ST}" stroke-width="1.3"/>`;
    s += `<path d="M59 71 L50 80 L55 86 Z" fill="#fff" stroke="${ST}" stroke-width="1.3"/>`;
    ...
    s += `<path d="M40 71 Q50 80 60 71 L50 83 Z" fill="${skin}" stroke="${ST}" stroke-width="1.2"/>`;
    s += `<path d="M24 76 Q31 73 36 76M76 76 Q69 73 64 76" stroke="${ST}" stroke-width="1.1" fill="none" opacity="0.5"/>`;
    s += `<rect x="60" y="86" width="11" height="9" rx="1.5" fill="none" stroke="${ST}" stroke-width="1.1" opacity="0.6"/>`;
    s += stethoscope();
  } else if (u === "coat") {
    s += `<path d="M40 71 Q50 80 60 71 L50 82 Z" fill="${C.mint}" stroke="${ST}" stroke-width="1.2"/>`;
    s += `<path d="M42 71 L33 97M58 71 L67 97" stroke="${ST}" stroke-width="1.4" fill="none"/>`;
    s += `<rect x="60" y="85" width="12" height="10" rx="1.5" fill="none" stroke="${ST}" stroke-width="1.1" opacity="0.6"/>`;
    s += `<rect x="62.5" y="82" width="2.4" height="7" rx="1" fill="${tieC}"/>`;
    s += stethoscope();
  } else if (u === "hoodie") {
    s += `<path d="M28 73 Q50 88 72 73 L70 94 L30 94 Z" fill="#78909c" stroke="${ST}" stroke-width="1.6" stroke-linejoin="round"/>`;
    s += `<path d="M42 71 Q50 81 58 71 Z" fill="${skin}" stroke="${ST}" stroke-width="1.2"/>`;
    s += `<path d="M44 76 L40 92M56 76 L60 92" stroke="${ST}" stroke-width="1.6" stroke-linecap="round"/>`;
    ...
    s += `<path d="M41 71 L50 80 L45 86 Z" fill="#ffebee" stroke="${ST}" stroke-width="1.3"/>`;
    s += `<path d="M59 71 L50 80 L55 86 Z" fill="#ffebee" stroke="${ST}" stroke-width="1.3"/>`;
  ...
  return s;
  function col(t: string) {
    if (t === "suit") return C.suit;
    if (t === "shirt") return C.shirt;
    if (t === "scrubs") return C.scrub;
    if (t === "coat") return C.coat;
    if (t === "hoodie") return "#90a4ae";
    if (t === "checkshirt") return "#eef6ff";
    return C.suit;
  }
}

function prop(type: string) {
...
export function buildEmoticonSVG(def: EmoticonDef): string {
  const f = def.face || {};
  ...
  return `<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" class="emo-svg" style="width:100%; height:100%; overflow:visible;">${parts.join("")}</svg>`;
}
