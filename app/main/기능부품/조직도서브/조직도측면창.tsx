...
export const SUB_MENUS: Record<string, SubMenuItem[]> = {
  ...
  인사관리: [
    // 결정 #40·#43 C안: 37장 → 7 워크센터, 활동 흐름 순 (일상 / 보상 / 인력관리 / 문서)
    { id: 'attend', label: '근태', group: '일상', icon: 'history' },
    { id: 'leave', label: '연차·휴가', group: '일상', icon: 'calendar' },
    { id: 'abnormal', label: '근태이상 감지', group: '일상', icon: 'alert' },
    { id: 'payroll', label: '급여', group: '보상', icon: 'calculator' },
    { id: 'member', label: '구성원', group: '인력관리', icon: 'users' },
    { id: 'welfare', label: '복지', group: '인력관리', icon: 'bell' },
      ...
      >
        <div className="flex w-full shrink-0 flex-col items-center px-2">
          <button
            ...
            aria-label="내정보"
          >
            <img src="/AllERP-transparent-trimmed.png" alt="AllERP" className="w-full h-full object-contain p-1" />
          </button>
