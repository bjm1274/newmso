...
function MessengerComposerImpl({
  ...
  return (
    ...
    >
      ...
      <div className={`chat-composer ${selectedRoomId === NOTICE_ROOM_ID && !canWriteNotice
        ...
        <div className="chat-comp-actions items-center">
          {canAttachFile && (
            <button
              type="button"
              ...
              aria-label="파일 첨부"
              title="파일 첨부"
              className="flex h-8 w-8 items-center justify-center rounded-[var(--radius-md)] text-[var(--toss-gray-4)] transition-colors hover:bg-[var(--tab-bg)] hover:text-[var(--foreground)] disabled:opacity-40"
            >
              {fileUploading ? (
                ...
                <svg aria-hidden="true" viewBox="0 0 20 20" className="h-[18px] w-[18px]" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M15.5 9.5l-5.7 5.7a3.4 3.4 0 0 1-4.8-4.8l6.4-6.4a2.3 2.3 0 0 1 3.2 3.2l-6.4 6.4a1.1 1.1 0 0 1-1.6-1.6l5.7-5.7" />
                </svg>
              )}
            </button>
          )}
          <div className="relative">
            <button
              ...
              title="이모지"
              className="flex h-8 w-8 items-center justify-center rounded-[var(--radius-md)] text-[var(--toss-gray-4)] transition-colors hover:bg-[var(--tab-bg)] hover:text-[var(--foreground)]"
            >
        ...
        <div className="chat-comp-input relative">
          <textarea
            ref={composerRef}
            data-testid="chat-message-input"
            rows={1}
            className="block min-h-[32px] max-h-9 w-full min-w-0 resize-none bg-transparent text-[16px] font-semibold leading-5 outline-none md:text-sm md:leading-5"
            placeholder={
        ...
        <span className="hidden shrink-0 select-none text-[11px] font-semibold text-[var(--zinc-400)] sm:inline">
          Enter 전송
        </span>
        <button
          type="button"
          ...
          aria-label="메시지 전송"
          className="chat-comp-send shrink-0 transition-all hover:scale-105 active:scale-95 disabled:opacity-50"
        >
          <svg aria-hidden="true" viewBox="0 0 20 20" className="h-[18px] w-[18px]" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
