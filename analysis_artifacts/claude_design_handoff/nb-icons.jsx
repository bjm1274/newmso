// MSO Icon Library — clean SVG icons, no emoji

const Icon = ({ name, size = 18, color = 'currentColor', strokeWidth = 1.6, className = '' }) => {
  const s = size;
  const sw = strokeWidth;
  const props = { width: s, height: s, viewBox: '0 0 24 24', fill: 'none', stroke: color, strokeWidth: sw, strokeLinecap: 'round', strokeLinejoin: 'round', className };
  ...
  if (!paths[name]) return <svg {...props}><line x1="4" y1="4" x2="20" y2="20"/><line x1="20" y1="4" x2="4" y2="20"/></svg>;
